...
from django.forms.utils import to_current_timezone, pretty_name
...
class Input(Widget):
    ...
    template_name = "templifys/forms/widgets/input.html"
...
class TextInput(Input):
    input_type = "text"
    template_name = "templifys/forms/widgets/text.html"
...
class Select(ChoiceWidget):
    input_type = "select"
    template_name = "templifys/forms/widgets/select.html"
    option_template_name = "templifys/forms/widgets/select_option.html"
    add_id_index = False
    checked_attribute = {"data-selected='true'": True}
